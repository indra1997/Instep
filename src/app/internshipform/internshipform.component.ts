...
export class InternshipformComponent implements OnInit{
  ...
  ngOnInit(): void {
    ...
    this.firstFormGroup = this.fb.group({
      ...
      additionalPhoneNumber: ['', [Validators.minLength(10), Validators.maxLength(10)]],
      permanentWorkAuthorization: ['India', [Validators.required]],
    ...
    this.secondFormGroup = this.fb.group({
      ...
      currentAcademicLevel: ['', [Validators.required]],
      currentAcademicYear: ['', [Validators.required]],
      overallCGPA: ['10', [Validators.required]],
      academicConcentration: ['', [Validators.required]],
      expectedGraduation: ['', [Validators.required]],
